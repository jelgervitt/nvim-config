return {
	...
	opts = {
		workspaces = {
			{
				name = "work",
				path = "/Users/Jelger/Library/Mobile Documents/iCloud~md~obsidian/Documents/Chunky Squirrel Obsidian/Chunky Squirrel/",
			},
		},
		...
		ui = {
			...
			hl_groups = {
				...
				ObsidianTodo = { bold = true, fg = "#d79921" }, -- yellow
				ObsidianDone = { bold = true, fg = "#A8B664" }, -- green
				ObsidianRightArrow = { bold = true, fg = "#d65d0e" }, -- orange
				ObsidianTilde = { bold = true, fg = "#fe8019" }, -- brighter orange
				ObsidianImportant = { bold = true, fg = "#fb4934" }, -- red
				ObsidianBullet = { bold = true, fg = "#83a598" }, -- faded blue
				ObsidianRefText = { underline = false, fg = "#d79921" }, -- purple/pink
				ObsidianExtLinkIcon = { fg = "#d79921" }, -- same as RefText
				ObsidianTag = { italic = true, fg = "#83a598" }, -- faded blue
				ObsidianBlockID = { italic = true, fg = "#83a598" }, -- faded blue
				ObsidianHighlightText = { bg = "#504945" }, -- gray (subtle highlight)
			},
		},
